/** Credits - Do not edit/remove this comment (Read http://TrollGamble.cryptogame.tk/LICENSE)
 * @desc TrollGamble.cryptogame.tk core source file
...
function onloadCallback() {
    grecaptcha.render('faucetClaimCaptcha', {
        'sitekey' : '6LcrFBAUAAAAANDKdxakWfjvmNsYshpuW3GKdbXK',
...
$(function(){
    ...
    $('#autoBet_button').click(function(){
        if(!user.connected){
            window.location.href = "https://www.moneypot.com/oauth/authorize?app_id=2564&response_type=token&state=Meh&redirect_uri=https://trolldice.github.io";
            return;
        }
        if(AutoRunning){
            AutoRunning = false;
...
function login(token){
    window.history.pushState('', 'TrollGamble', '/');
